...
class MainScreen extends StatefulWidget {
  ...
  const MainScreen({Key? key, this.nama, this.iduser, this.motivasi})
      : super(key: key);
  @override
...
class _MainScreenState extends State<MainScreen> {
  ...
  Future<List<MotivasiModel>> getData() async {
    var response =
        await dio.get('$baseurl/vigenesia/api/Get_motivasi'); // NGambil by data
    print(" ${response.data}");
